    ...
    content: (
      <>
        ...
        <p>
          ...
          parents' support was mixed: Dad bought me an F-150 but used the keys
...

  {
    ...
    content: (
      <>
        ...
        <br />
        <p>
          <strong>Meet Our Team Members' Stories:</strong>
        </p>
        <br />
        <p>
    ...
    content: (
      <>
        ...
        <p>
          ...
          them. The case was dismissed in December 2024 “in the interest of
          justice,” but the media's false narrative cost James half his clients
          and personal connections. Yet he emerged advocating for workplace
          mental health reforms and community resilience in Apex, NC, proving
          evil never wins.
        </p>
      </>
    ),
